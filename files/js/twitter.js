...
AudioScrobbler.prototype = {
	...
	init: function( dataGraph, particleModel ) {
		...
		this.MAX_PRODUCTS_ORIGIN = 18;
		this.MAX_PRODUCTS_PER_SIMILARITY = 15;
		this.MAX_NODES = 38;
	...
	getArtist: function( artistName, graphNode ) {
		var artistURL = "../../getpic/twitter/?id=" + artistName;
	...
	getSimilar: function( artist, ordinal ) {
		var similarityURL = "../../getcontacts/twitter/?id=" + artist;
